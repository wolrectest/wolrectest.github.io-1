...
<div>
    ...
    <div class="container-fluid bg-dark p-5">
        <div class="row">
            <div class="col-12 text-center">
                <h1 class="display-4 text-white">WOLREC - Vacancies</h1>
                <a href="vacancy.php">View All Vacancies</a>
    ...
    <div class="container-fluid py-6 px-5">
        ...
        $query = "SELECT * FROM vacancies  WHERE v_id = '$p_id'";
        //running the query
...
<p>
            ...
            <div class="col-lg-4">
                ...
                <!-- Recent Post Start -->
                <div class="mb-5">
                    <h2 class="mb-4">Recent Vacancies</h2>
                    <?php
                $query = "SELECT * FROM vacancies  ORDER BY v_id desc limit 0,4";
