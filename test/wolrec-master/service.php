    ...
    <div class="container-fluid bg-dark p-5">
        <div class="row">
            <div class="col-12 text-center">
                <h1 class="display-4 text-white">WELCOME TO WOLREC</h1>
    ...
    <div class="container-fluid bg-secondary px-0">
        <div class="row g-0">
            <div class="col-lg-6 py-6 px-5">
                <h1 class="display-5 mb-4">Our Objective</h1>
                <p class="mb-4">To lobby and advocate for gender equality, good governance, democracy, transparency, accountability and corruption free society.</p>
