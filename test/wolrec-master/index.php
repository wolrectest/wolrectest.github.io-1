...
<div>
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="img/blog.jpg" alt="Image">
    ...
    <div class="container-fluid bg-secondary p-0">
        <div class="row g-0">
            <div class="col-lg-6 py-6 px-5">
                <h1 class="display-5 mb-4">WELCOM TO WOLREC</h1>
    ...
    <!-- Services Start -->
    <div class="container-fluid bg- text-secondary p-5" style = "background-color:#380052">
        <div class="row g-5 " >
            <div class="col-12 text-center bg-" style = "background-color:#380052">
        ...
        <div class="row g-5">
            <div class="col-lg-4">
                <div class="team-item position-relative overflow-hidden">
                    ...
                    <div class="team-text w-100 position-absolute top-50 text-center bg-warning p-4">
                        <h3 class="text-white">Mphatso Willie</h3>
            ...
            <div class="col-lg-4">
                <div class="team-item position-relative overflow-hidden">
                    ...
                    <div class="team-text w-100 position-absolute top-50 text-center bg-warning p-4">
                        <h3 class="text-white">Chiko Willie</h3>
                        <p class="text-white text-uppercase mb-0">Engineer</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="team-item position-relative overflow-hidden">
                    ...
                    <div class="team-text w-100 position-absolute top-50 text-center bg-warning p-4">
                        <h3 class="text-white">Shadie Shadrick</h3>
                        <p class="text-white text-uppercase mb-0">Marketing Manager</p>
                    </div>
                </div>
            </div>
        </div>
