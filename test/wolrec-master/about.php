            ...
            <div class="navbar-nav ms-auto py-0 me-n3">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0">
                        ...
                        <a href="#" class="dropdown-item">Galley</a>
                       
                        <a href="#" class="dropdown-item">Download Files</a>
    ...
    <div class="container-fluid bg-secondary p-0">
        <div class="row g-0">
            <div class="col-lg-6 py-6 px-5">
                <h1 class="display-5 mb-4">Welcome To <span class="text-primary">WOLREC</span></h1>
                <h4 class="text-primary mb-4">Who are we?</h4>
                <p class="mb-4">Women’s Legal Resources Centre (WOLREC) is a women’s rights Non-governmental organization based in Blantyre. WOLREC is housed at Naperi, Kenyatta Drive, Plot No. SW8/517/3&4. WOLREC was registered under the Trustees Incorporation Act (1962) in 2006 and became operational the same year. WOLREC’s mission is to facilitate increased access to legal, socio-political and economic justice for women and girls in Malawi.</p>
                <h4 class="text-primary mb-4">Major Activities Implemented by Women’s Legal Resources Centre</h4>
                <p class="mb-4"><ul style="list-style-type: bullets">
<li>Capacity development of rights holders and duty bearers on human rights and gender issues</li>
<li>Facilitating access to legal assistance and services to rural and peri-urban women and girls</li>
<li>Information, Education and Communication on gender and human rights issues using the edutainment model</li>
<li>Behavioural change interventions on eradication of harmful cultural and traditional practices</li>
<li>Research on human rights and gender</li>
<li>Economic literacy and empowerment of women</li>
<li>Local and national advocacy on human rights and gender.</li></ul></p>
            </div>
            <div class="col-lg-6">
                <div class="h-100 d-flex flex-column justify-content-center bg-primary p-5">
                    <div class="d-flex text-white mb-5">
                        ...
                        <div class="ps-4">
                            <h3>WOLREC is guided by the following objectives</h3>
                            <p class="mb-0"><ul style="list-style-type: bullets">
   <li>To lobby and advocate for gender equality, good governance, democracy, transparency, accountability and corruption free society.</li>
   <li>To provide legal aid and assistance to women and girls in Malawi.</li>
   <li>To provide and identify economic opportunities for women for the advancement of their lives.</li>
<li>To promote awareness of the legal and human rights of females with a view of curtailing gender-based violence, abuses relating to reproductive rights, cultural imbalances that disadvantage females, enhance female empowerment etc.



<li>To consolidate democratic and local governance values as they affect females.</li>
<li>To conduct research on matters affecting women and girls in Malawi.</li></ul></p>
                        </div>
                    </div>
                    <div class="d-flex text-white mb-5">
                        <div class="d-flex flex-shrink-0 align-items-center justify-content-center bg-white text-primary rounded-circle mx-auto mb-4" style="width: 60px; height: 60px;">
                        ...
                        <div class="ps-4">
                            ...
                            <p class="mb-0">WOLREC believes in and upholds the following values:
                            <ul style="list-style-type: bullets">
<li>Empowerment of vulnerable groups especially girls and women</li>
<li>Gender Equity and Equality</li>
<li>Diversity</li>
<li>Respect for human rights</li>
<li>Transparency and accountability</li></ul></p>
                        </div>
                    </div>
                    <div class="d-flex text-white">
                        ...
                        <div class="ps-4">
                            <h3>Result Areas</h3>
                            <p class="mb-0">WOLREC delivers on three result areas that have been prioritized in all the projects and these are:
                            <ul style="list-style-type: bullets"> 
                            <li>Reduced gender based violence as well as practices which perpetuate them.</li>
<li>Improved women’s participation in decision making processes</li>
<li>Reduced women’s and adolescent girls vulnerability to HIV and AIDS</li>
<li>Improved economic well-being of women.</li>
