                ...
                <div class="app-main__inner">
                    ...
                    <div class="main-card mb-3 card">
                        <div class="card-header">
                           ...
                           POSITION:  <?php echo $row['position']; ?>
                            <div class="btn-actions-pane-right actions-icon-btn">
                                By Admin <i class="pe-7s-leaf icon-gradient bg-arielle-smile" style="font-size: large;"></i>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="scroll-area-lg">
                                <div class="scrollbar-container ps--active-y">
                                    <h4>Summary</h4>
                                    <p style="text-align:justify;"><?php echo $row['summary'] ?> </p><br>
                                    <h4>Requirements</h4>
                        ...
                        <div class="d-block text-right card-footer">
                            Closing Date: </b> <?php echo date('d F, Y', strtotime($row['closing_date'])); ?>  <i class="pe-7s-date icon-gradient bg-arielle-smile" style="font-size: large;"></i>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
